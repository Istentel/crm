...
if(isset($_POST["submit"])){
    ...
    if($first_name == null || $last_name == null || $email == null || $phone == null || $company == null || $prod_vandute == null){
        ...
        #Create query
        $query = 'INSERT INTO sellersagent(id, first_name, last_name, email, phone, firme_asociate, grupuri, activ, prod_vandute, data_angajare) VALUES(:id, :first_name, :last_name, :email, :phone, :firme_asociate, :grupuri, :activ, :prod_vandute, :data_angajare)';
